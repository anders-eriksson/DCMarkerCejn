using AddMaskinIDRows.ExpressionBuilder;
using DCLog;
using DCMarkerEF;
using System;
...
using System.Linq;
using GlblRes = global::AddMaskinIDRows.Properties.Resources;
    ...
    public class DB : IDisposable
    {
        ...
        public ObservableCollection<LaserData> LoadLaserDataFilteredText(string filterKey, string filterValue)
        {
            ...
            catch (OutOfMemoryException ex)
            {
                ...
                ErrorMessage = "Out_of_memory_Please_use_a_filter_to_make_selection_smaller";
                Log.Fatal(ex, "Out_of_memory_Please_use_a_filter_to_make_selection_smaller");
            }
            catch (Exception ex)
            {
                Log.Fatal(ex, "LoadLaserDataFiltered_exception");
                throw;
            }
        ...
        public void SaveChanges()
        {
            ...
            catch (DbEntityValidationException dbEx)
            {
                foreach (DbEntityValidationResult entityErr in dbEx.EntityValidationErrors)
                {
                    ...
                    {
                        Log.Error(string.Format("Error_Property_Name_0__Error_Message_1",
            ...
            catch (Exception ex)
            {
                ...
                Log.Error(ex, "SaveChanges_Exception");
                throw;
            }
        }
